    ...
    return (
        <div>
            <nav className="h-[70px] relative w-full px-6 md:px-16 lg:px-24 xl:px-32 flex items-center justify-between z-30 bg-linear-to-r from-indigo-700 to-violet-500 transition-all">
                ...
                <div className="mobile-menu absolute top-[70px] left-0 w-full bg-linear-to-r from-indigo-700 to-violet-500 p-6 hidden md:hidden">
                    <ul className="flex flex-col space-y-4 text-white text-lg">
                        <li>
                            <NavLink to="/" className="text-sm">Home</NavLink>
                        </li>
                        <li>
                            <NavLink to="/details" className="text-sm">Home</NavLink>
                        </li>
                    </ul>
